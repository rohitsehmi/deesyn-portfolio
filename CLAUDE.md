...
**Three checksums, three sources.** Tokens `4115829316`. Figma components `1567749477`. Banding spec `2143010685`, reproduced from inside Figma by `design/banding-export.snippet.js` (matched 2026-08-05). Code-only specs print `458711991` but have no Figma counterpart to match, by definition.
