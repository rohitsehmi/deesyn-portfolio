...
**One build serves five brands, chosen by hostname.** `www.deesyn.com` shows the **Ro mark alone and names no company**; `wise.deesyn.com` shows Ro × Wise (2026-08-13); `healf.deesyn.com` shows Ro × Healf (2026-08-14); `ticketmaster.deesyn.com` and `asos.deesyn.com` were added on 2026-08-26. Each partner carries its own hero copy and its own Figma receipt.
